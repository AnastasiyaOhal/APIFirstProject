...
public class SingleUserSteps {
    ...
    public void i_request_Single_User_with_method_get() throws URISyntaxException, IOException {
    ...
    @Then("single user status should be {int}")
    ...
    public void single_User_is_displayed() throws IOException {
        String reqBody = reqresUtils.generateStringResource("src/test/java/Utils/JsonFiles/SingleUser.json");
